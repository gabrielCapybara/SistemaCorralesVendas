...
private JDlgUsuarios jDlgUsuarios;
 ...
 UsuarioControle usuarioControle;
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        if(jTxtNome.getText().equals("") && jTextField1.getText().equals("")){
            ghsUsuarios_DAO = new GhsUsuarios_DAO();
            List lista = ghsUsuarios_DAO.listAll();
        } else {
             if(jTxtNome.getText().equals("") && !jTextField1.getText().equals("")){
                 List lista = ghsUsuarios_DAO.listNomeECpf(jTxtNome.getText(), jTextField1.getText());
                 usuarioControle.setList(lista);
        } else {
            if(!jTxtNome.getText().equals("")){
                List lista = ghsUsuarios_DAO.listNome(jTxtNome.getText());
                usuarioControle.setList(lista);
        } else {
            if(!jTextField1.getText().equals("")){
                List lista = ghsUsuarios_DAO.listCpf(jTextField1.getText());
                usuarioControle.setList(lista);
             }      
           }
         }
