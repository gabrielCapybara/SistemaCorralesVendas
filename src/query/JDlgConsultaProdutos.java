...
private JDlgProdutosNovo jDlgProdutosNovo;
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(ghs_quantidade, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
         if(ghs_nome.getText().equals("") && ghs_quantidade.getText().equals("")){
            ...
            if(!ghs_nome.getText().equals("")){
                List lista = ghsProdutos_DAO.listNome(ghs_nome.getText());
                produtosControle.setList(lista);
        } else {
            if(!ghs_quantidade.getText().equals("")){
                List lista = ghsProdutos_DAO.listQuantidade(Util.strInt(ghs_quantidade.getText()));
                produtosControle.setList(lista);
             }      
           }
         }
